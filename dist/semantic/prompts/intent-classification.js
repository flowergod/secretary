...
exports.INTENT_CLASSIFICATION_PROMPT = void 0;
exports.INTENT_CLASSIFICATION_PROMPT = {
...
【重要】
1. category 字段只能是"工作"、"个人"或"家庭共享"，禁止使用其他值（如"课程"、"培训"等）
2. 如果任务包含"妙妙"、围棋、钢琴、舞蹈、兴趣班等关键词，category 必须是"家庭共享"
3. "围棋课"、"钢琴课"、"舞蹈课"等兴趣班都属于"家庭共享"
4. 如果无法判断，默认使用"工作"
...
//# sourceMappingURL=intent-classification.js.map