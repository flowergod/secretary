...
exports.llmParseService = exports.LLMParseService = void 0;
...
class LLMParseService {
    constructor() {
        ...
        const appConfig = config_1.configManager.get();
    ...
    async parse(input, context) {
        try {
            ...
            // 调用 LLM
            const response = await router_1.aiRouter.chat({
                messages: [
...
exports.LLMParseService = LLMParseService;
exports.llmParseService = new LLMParseService();
//# sourceMappingURL=llm-parse-service.js.map